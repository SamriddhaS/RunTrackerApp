...
import com.samriddha.runningapphilt.other.CustomMarkerView
import com.samriddha.runningapphilt.other.TrackingUtility
import com.samriddha.runningapphilt.ui.viewmodels.StatisticsViewModel
...
class StatisticsFragment :Fragment(R.layout.fragment_statistics) {
    ...
    private fun subscribeToObservers(){
        ...
        viewModel.totalTimeRan.observe(viewLifecycleOwner, Observer {
            it?.let {
        ...
        viewModel.totalDistance.observe(viewLifecycleOwner, Observer {
            it?.let {
                val km = it/1000f
                val totalDistance = round(km*10)/10
        ...
        viewModel.runsSortedByDate.observe(viewLifecycleOwner, Observer {
            ...
            it?.let {
                val allAvgSpeed = it.indices.map { i -> BarEntry(i.toFloat(),it[i].avgSpeedKPH) }
                ...
                barChart.marker  =CustomMarkerView(it.reversed(),requireContext(),R.layout.marker_item)
                barChart.invalidate()
            }
        })
